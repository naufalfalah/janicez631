...
<body>
                    ...
                    <div class="row flex-column-reverse flex-sm-row">
                        <div class="col-md-6 banner-content-wrapper">
                            <div class="form-section">
                                ...
                                <input type="hidden" name="condo_project_name" id="project_name">
                                <input type="hidden" name="source_url" value="https://launchgovtest.homes/">
                                <input type="hidden" id="otp" name="wp_otp">
                                    <div class="form-group">
                                        <label>Project Name</label>
                                        <select id="select-project1" name="condo_project"  required>
                                            <?= $condo_project_option ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>Blk</label>
                                        <input type="text"  id="blkfield" class="unit_number" placeholder="Blk" name="blk" required="">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="radio-group">
                                            <label><input type="radio" name="sellCheck" value="1-3 months" required> 1-3 months</label>
                                            <label><input type="radio" name="sellCheck" value="3-6 months" required> 3-6 months</label>
                                            <label><input type="radio" name="sellCheck" value="6-12 months" required> 6-12 months</label>
    ...
    <script>
        $('#select-project1').on('change', function() {
            let selectedOption = $(this).find('option:selected'); 
            $('#project_name').val(selectedOption.text());
        });
